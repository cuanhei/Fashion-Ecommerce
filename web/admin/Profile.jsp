...
<body class="bg-light adminBody">
    ...
    <div class="page d-flex align-items-center justify-content-center my-lg-4 ">
        <form class="container-sm bg-white shadow-sm rounded p-3 mt-5" method="post" action="UpdateProfile" enctype="multipart/form-data">
            ...
            <div class="mt-4 row">
                ...
                <div class="col-lg-8 px-3 d-block">
                    ...
                    <input class="w-100" type="text" name="name" value="${loggedAcc.person.name}"><br>
                    ...
                    <input class="w-100" type="text" name="email" value="${loggedAcc.person.email}"><br>
                    ...
                    <textarea class="w-100 border" name="address" id="">${loggedAcc.person.address}</textarea><br>
                    ...
                    <input class="w-100" type="text" name="ic" value="${loggedAcc.person.ic}"><br>
                    ...
                    <input class="w-100" type="text" name="contact" value="${loggedAcc.person.contact}"><br>
